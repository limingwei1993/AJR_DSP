 ...
 * */
/*429 read ADDR*/
#define       ADDR_HYDRAULIC_SYSTEM_PRESSURE        (0x400 | (0x030<<2) | Board_ID)                 /*油源压力1_60*/
#define       ADDR_ACCUMULATOR_SYSTEM_PRESSURE      (0x400 | (0x056<<2) | Board_ID)                 /*蓄压器压力1_126*/
#define       ADDR_TLA_POSITION_LEFT                (0x400 | (0x05B<<2) | Board_ID &0xffe | 0x001)  /*左油门杆位置_133*/
#define       ADDR_TLA_POSITION_RIGHT               (0x400 | (0x05B<<2) | Board_ID &0xffe | 0x000)  /*右油门杆位置_133*/
#define       ADDR_MASTER_TIME                      (0x400 | (0x068<<2) | Board_ID)                 /*主机时间_150*/
#define       ADDR_AIRSPEED                         (0x400 | (0x086<<2) | Board_ID)                 /*Computed_Air_Speed_206--计算空速*/
#define       ADDR_DATE_MASTER                      (0x400 | (0x0B0<<2) | Board_ID)                 /*主机日期_260*/
#define       ADDR_LG_GEARDOWN_LOCKED               (0x400 | (0x0BA<<2) | Board_ID)                 /*Gear_Position_1_272（Bit13）--起落架位置1*/
#define       ADDR_COMPUTED_WOW_DATA1               (0x400 | (0x0BF<<2) | 0x002)                    /*计算轮载数据1_277*/
#define       ADDR_COMPUTED_WOW_DATA2               (0x400 | (0x0BF<<2) | 0x001)                    /*计算轮载数据2_277*/
#define       ADDR_AIRCRAFTACCELERATION_LEFT        (0x400 | (0x0D9<<2) | 0x002)                    /*Longitudinal_Acceleration_Body_Left_331--机体左侧纵向加速度*/
#define       ADDR_AIRCRAFTACCELERATION_RIGHT       (0x400 | (0x0D9<<2) | 0x001)                    /*Longitudinal_Acceleration_Body_Right_331--机体右侧纵向加速度*/
/*429 write ADDR*/
#define       ADDR_LEFT_WHEEL_SPEED                 (0x400 | (0x006<<2) | Board_ID)                 /*--左轮轮速_006*/
#define       ADDR_RIGHT_WHEEL_SPEED                (0x400 | (0x007<<2) | Board_ID)                 /*--右轮轮速_007*/
#define       ADDR_LEFT_BRAKE_CONTROL_VALVE_CURENT  (0x400 | (0x029<<2) | Board_ID)                 /*--左轮刹车控制阀电流 _051*//*回采*/
#define       ADDR_RIGHT_BRAKE_CONTROL_VALVE_CURENT (0x400 | (0x02A<<2) | Board_ID)                 /*--右轮刹车控制阀电流_052*//*回采*/
#define       ADDR_LEFT_BRAKE_PRESSURE              (0x400 | (0x038<<2) | Board_ID)                 /*左轮刹车压力_070 */
#define       ADDR_RIGHT_BRAKE_PRESSURE             (0x400 | (0x039<<2) | Board_ID)                 /*右轮刹车压力_071 */
#define       ADDR_SHUTOFF_VALVE_CURRENT            (0x400 | (0x04B<<2) | Board_ID)                 /*切断阀电流检测_113 *//*回采*/
#define       ADDR_LEFT_BRAKE_TEMPERATURE           (0x400 | (0x04C<<2) | Board_ID)                 /*左轮刹车温度_114 */
#define       ADDR_RIGHT_BRAKE_TEMPERATURE          (0x400 | (0x04E<<2) | Board_ID)                 /*右轮刹车温度_116 */
#define       ADDR_LEFT_BRAKE_PEDAL_POSITION_PILOT    (0x400 | (0x079<<2) | Board_ID)               /*主驾左脚蹬_171*/
#define       ADDR_RIGHT_BRAKE_PEDAL_POSITION_PILOT   (0x400 | (0x07A<<2) | Board_ID)               /*主驾右脚蹬_172*/
#define       ADDR_LEFT_BRAKE_PEDAL_POSITION_COPILOT  (0x400 | (0x07B<<2) | Board_ID)               /*副驾左脚蹬_173*/
#define       ADDR_RIGHT_BRAKE_PEDAL_POSITION_COPILOT (0x400 | (0x07C<<2) | Board_ID)               /*副驾右脚蹬_174*/
#define       ADDR_WARNING                            (0x400 | (0x0B8<<2) | Board_ID)               /*警告_270*/
#define       ADDR_STATUS_1                           (0x400 | (0x0B9<<2) | Board_ID)               /*状态文字#1_271*/
#define       ADDR_STATUS_2                           (0x400 | (0x0BA<<2) | Board_ID)               /*状态文字#2_272*/
#define       ADDR_BCU_AIRCRAFT_REFERENCE_SPEED       (0x400 | (0x0C2<<2) | Board_ID)               /*BCU飞机参考速度_302*/
#define       ADDR_FAILURE_WORD_1                     (0x400 | (0x0E8<<2) | Board_ID)               /*故障文字#1_350*/
#define       ADDR_FAILURE_WORD_2                     (0x400 | (0x0E9<<2) | Board_ID)               /*故障文字#2_351*/
#define       ADDR_FAILURE_WORD_3                     (0x400 | (0x0EA<<2) | Board_ID)               /*故障文字#3_352*/
#define       ADDR_FAILURE_WORD_4                     (0x400 | (0x0EB<<2) | Board_ID)               /*故障文字#4_353*/
/*FPGA本板卡采集信号*/
