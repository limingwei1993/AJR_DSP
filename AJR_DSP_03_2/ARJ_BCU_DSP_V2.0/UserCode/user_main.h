...
typedef  struct _429_DATA_RX
{
    ...
    kcg_bool In_MLG_LtDownlocked;                /*Gear_Position_1_272（Bit14）--起落架位置2*/
...
{
        kcg_bool SOV_Open;                      /*模型输出SOV指令 */
        kcg_float32 BrakePressureCommand_L;     /*模型输出压力指令左 */
        kcg_float32 BrakePressureCommand_R;     /*模型输出压力指令右*/
        kcg_bool CoilEnergized;                 /*模型输出自动刹车开关*/
        kcg_float32 LeftPDL_BrakePressureCommand;   /*脚蹬功能指令左*/
        kcg_float32 RightPDL_BrakePressureCommand;  /*脚蹬功能指令右*/
        kcg_float32 LeftBrakePressureCommand;   /*选择模块指令左*/
        kcg_float32 RightBrakePressureCommand;  /*选择模块指令右*/
        kcg_float32 LeftIFB_BrakePressureCommand;   /*止转模块指令左*/
        kcg_float32 RightIFB_BrakePressureCommand;  /*止转模块指令右*/
        kcg_float32 Left_BrakePressureCommand;  /*自动刹车模块指令左*/
        kcg_float32 Right_BrakePressureCommand; /*自动刹车模块指令右*/
        kcg_bool LandingArmedState;
        kcg_bool LandingApplicationState;
        kcg_bool LandingEnabledState;
        kcg_bool LandingDisArmedState;
        ...
        kcg_bool latch;
        kcg_bool unlatch;
        kcg_float32 maxpedal;   /*最大脚蹬*/
        kcg_bool WOWBK;         /*刹车系统WOW*/
        kcg_bool WOW429;        /*总线WOW*/
        kcg_bool TDP_BrakeInhibit; /*接地保护激活*/
        kcg_bool LWP_LeftBrakeInhibit;   /*锁轮-左*/
        kcg_bool LWP_RightBrakeInhibit;  /*锁轮-右*/
...
extern  short temp_value_right;   /*右轮温度值*/
extern  short temp_value_left;    /*左轮温度值*/
