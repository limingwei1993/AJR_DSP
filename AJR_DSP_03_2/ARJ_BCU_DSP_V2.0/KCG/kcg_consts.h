...
/* Auto_KP */
#define Auto_KP (kcg_lit_float32(700.))

/* Auto_KI */
#define Auto_KI (kcg_lit_float32(100.))

/* DT */
#define DT (kcg_lit_float32(0.005))

/* PedaldisArm */
#define PedaldisArm (kcg_lit_float32(0.1))

/* RTO_ARM */
#define RTO_ARM (kcg_lit_float32(10.))

/* Pedal_RTO */
#define Pedal_RTO (kcg_lit_float32(0.1))

/* Brakespeed */
#define Brakespeed (kcg_lit_float32(60.0))

/* RTO_H */
#define RTO_H (kcg_lit_float32(70.))

/* Acc_Lo */
#define Acc_Lo (kcg_lit_float32(5.0))

/* Acc_MED */
#define Acc_MED (kcg_lit_float32(7.0))

/* Acc_HI */
#define Acc_HI (kcg_lit_float32(9.))
...
/* HzTOrad */
#define HzTOrad (kcg_lit_float32(10.))
